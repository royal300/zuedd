        ...
        >
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 lg:p-8">
            <div className="glass-card rounded-sm p-5 lg:p-6 transform transition-all duration-500 group-hover:-translate-y-2">
              <p className="text-gold text-[10px] tracking-[0.4em] uppercase font-semibold mb-2">
                Premium Collection
              </p>
              <h2 className="font-display text-4xl lg:text-5xl text-foreground tracking-wider leading-none mb-3 group-hover:gold-gradient-text transition-all duration-300">
                T-SHIRTS
              </h2>
              <p className="text-muted-foreground text-xs tracking-wider mb-4">
                Oversized · Baggy · Regular Fit
              </p>
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 right-0 p-6 lg:p-8">
            <div className="glass-card rounded-sm p-5 lg:p-6 transform transition-all duration-500 group-hover:-translate-y-2">
              ...
              <h2 className="font-display text-4xl lg:text-5xl text-foreground tracking-wider leading-none mb-3">
                JEWELLERY
              </h2>
              <p className="text-muted-foreground text-xs tracking-wider mb-4">
                Earrings · Rings · Chains · Pendants
              </p>
              <div className="flex items-center gap-2">
                <span className="btn-gold px-5 py-2.5 rounded-sm text-xs inline-flex items-center gap-2">
                  Explore Collection
